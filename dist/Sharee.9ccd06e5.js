...
var n = (r, s, e) => (D(r, typeof s != "symbol" ? s + "" : s, e), e);
...
function m(r, s) {
  var e, t;
  do {
    if (typeof ((e = r == null ? void 0 : r.className) == null ? void 0 : e.includes) < "u" && ((t = r == null ? void 0 : r.className) == null ? void 0 : t.includes(s)))
      return !0;
    r = r.parentNode;
  } while (r);
  return !1;
...
class R extends d {
  constructor(e) {
    ...
    n(this, "driverListeners", {});
    n(this, "options");
    this.sharee = e, this.shareeEl = document.createElement("div"), this.options = l({}, O, e.options.modeOptions);
  }
  destroy() {
    var e;
    window.shareeEl = this.shareeEl, this.eventListeners.forEach((t) => {
...
class c {
  ...
  async setLang(s, e = {}) {
    const t = /* @__PURE__ */ Object.assign({ "../locales/en.json": () => import("./en.30716096.js"), "../locales/fa.json": () => Promise.resolve().then(() => b) });
    let i = h;
    for (const o in t)
