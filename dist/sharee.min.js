...
`;class Zt extends j{constructor(t,i){super(t,i);o(this,"buttonText","Copy Link");o(this,"icon",Xt);o(this,"backgroundColor","#797979");o(this,"backgroundHoverColor","#5e5e5e");o(this,"textColor","#fff");o(this,"textHoverColor","#fff");o(this,"timeout",0)}onClick(t){super.onClick(t);const i=this.lang.CopiedSuccessfully,g=t.currentTarget.querySelector("div:nth-child(2)");if(g.innerHTML===i){g.innerHTML=this.getButtonText();return}let M=window.location.href;navigator.clipboard.writeText(M).then(()=>{g.innerHTML=i,g.style.transition="300ms all",g.style.transform="scale(1)",g.style.transform=`scale(1.07) translateX(${this.lang.Direction==="rtl"?"-":""}4px)`,clearTimeout(this.timeout),this.timeout=setTimeout(()=>{g.innerHTML=this.getButtonText(),g.style.transition="none",g.style.transform="scale(1)"},5e3)})}}const qt=`<svg\r
...
</svg>`;class nn extends j{constructor(t,i){super(t,i);o(this,"buttonText","Eitaa");o(this,"icon",tn);o(this,"backgroundColor","#e3791c");o(this,"backgroundHoverColor","#d5721a");o(this,"textColor","#fff");o(this,"textHoverColor","#fff")}getLink(){var t,i;return`https://eitaa.com/share/url?url=${(t=this.options)==null?void 0:t.shareLink}&text=${encodeURIComponent((i=this.options)==null?void 0:i.shareText)}`}}const rn=new Object({telegram:Vt,whatsapp:Wt,copy:Zt,twitter:Kt,linkedin:Jt,facebook:en,eitaa:nn});class te{constructor(s,t=_){o(this,"options");o(this,"lang",xe);o(this,"strategy");o(this,"targetElement");this.targetElement=s,this.options=W({},_,t),this.options.drivers=t.drivers||this.options.drivers;const i=Ft[this.options.mode];if(typeof i>"u")throw new Error('Selected mode "'+t.mode+'" not found');this.strategy=new i(this),typeof window<"u"&&this.init().then(()=>{this.strategy.render()})}static addDriver(s,t){this.drivers[s]=t}async init(){this.targetElement.sharee=this,await this.setLang(this.options.lang,this.options.langs)}async setLang(s,t={}){const i=Object.assign({"../locales/en.json":()=>Promise.resolve().then(()=>on),"../locales/fa.json":()=>Promise.resolve().then(()=>zt)});let h=xe;for(const g in i)g.includes(s)&&(i[g]instanceof Function?h={...await i[g]()}:h={...i[g]},t[s]&&W(h,t[s]));this.lang=h}getShareText(){return this.options.shareText||document.title}getShareLink(){return this.options.shareLink||window.location.href}destroy(){this.strategy.destroy()}}o(te,"drivers",{...rn});var Se={exports:{}};/*!
 * ripple-effects
 * customizable ripple effect with one line of code
 *
 * @version v1.0.2
 * @author Cris Fandiño <sircnujnuj@gmail.com>
 */(function(d,s){(function(t,i){d.exports=i()})(G,function(){function t(l,u,c){return u in l?Object.defineProperty(l,u,{value:c,enumerable:!0,configurable:!0,writable:!0}):l[u]=c,l}function i(l,u){var c=Object.keys(l);if(Object.getOwnPropertySymbols){var C=Object.getOwnPropertySymbols(l);u&&(C=C.filter(function(w){return Object.getOwnPropertyDescriptor(l,w).enumerable})),c.push.apply(c,C)}return c}function h(l){for(var u=1;u<arguments.length;u++){var c=arguments[u]!=null?arguments[u]:{};u%2?i(Object(c),!0).forEach(function(C){t(l,C,c[C])}):Object.getOwnPropertyDescriptors?Object.defineProperties(l,Object.getOwnPropertyDescriptors(c)):i(Object(c)).forEach(function(C){Object.defineProperty(l,C,Object.getOwnPropertyDescriptor(c,C))})}return l}function g(l){return/^-+/.test(l)?l:/([^\-]+)([A-Z])/g.test(l)?l.replace(/[A-Z]/g,function(u){return"-"+u.toLowerCase()}):l.toLowerCase()}function M(l,u){var c=l instanceof Element?l:document.createElement(l);if(!u)return c;for(var C in u){var w=u[C];if(/^on([A-Z][a-z A-Z])+/.test(C)){var z=C.toLowerCase().substr(2);c.addEventListener(z,w)}else switch(C){case"style":$(c,w);break;case"appendTo":if(!w)break;w.appendChild(c);break;case"appendChild":c.appendChild(w);break;case"dataset":c.dataset[w[0]]=w[1]||"";break;default:c[C]=w}}return c}function $(l,u){if(typeof u=="string")return getComputedStyle(l).getPropertyValue(g(u));for(var c in u)l.style.setProperty(g(c),u[c])}function ne(l,u){return M(l,u),{on:function(c,C,w){c.split(" ").forEach(function(z){l.addEventListener(z,C,w)})},off:function(c,C){c.split(" ").forEach(function(w){l.removeEventListener(w,C)})}}}function re(l){return["hr","br","img","col","input","embed","area","base","keygen","source","track","wbr"].indexOf(l.tagName.toLowerCase())>-1}function ie(l){var u,c={top:0,left:0};return u=(l&&l.ownerDocument).documentElement,l.getBoundingClientRect!==void 0&&(c=l.getBoundingClientRect()),{top:c.top+window.pageYOffset-u.clientTop,left:c.left+window.pageXOffset-u.clientLeft}}function se(l){for(var u=[],c=0;c<l.length;c++)u.push(l[c]);return u}function oe(l){var u=arguments.length>1&&arguments[1]!==void 0?arguments[1]:document,c=l instanceof HTMLCollection||l instanceof NodeList;return c?se(l):l instanceof Element?[l]:se(u.querySelectorAll(l))}var ae=Object.freeze({__proto__:null,tag:M,styles:$,edit:ne,isSelfTag:re,offset:ie,elementToArray:oe}),He={background:"rgb(150,150,150)",opacity:.5,zIndex:99,duration:700,timing:"ease",outDuration:800},X=M,B=ne,le=ie,Z=oe,je=re,q=$;function ce(){var l=arguments.length>0&&arguments[0]!==void 0?arguments[0]:"_",u=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},c=u=h(h({},He),u),C=c.background,w=c.opacity,z=c.zIndex,ze=c.duration,Pe=c.timing,Ae=c.height,Re=c.width,he=c.triggerOnChild,Ie=he===void 0||he,ue=c.triggerExcept,$e=ue===void 0?"_":ue,de=c.outDuration,pe="ontouchstart"in window;function fe(b){if(!(Z($e,this).indexOf(b.target)>-1)&&(b.target===this||Ie)){var D,N;q(this,"position").toLowerCase()==="static"&&(this.style.position="relative");var H=le(this).top,Y=le(this).left;try{if(b.touches[1])return;N=b.touches[0].pageX-Y,D=b.touches[0].pageY-H}catch{N=b.pageX-Y,D=b.pageY-H}var P=this.offsetWidth,ge=this.offsetHeight,F=X("div",{appendTo:this,className:"ripleParent__",style:{zIndex:z,height:ge+"px",width:P+"px",borderRadius:q(this,"borderRadius"),clipPath:q(this,"clipPath"),transition:"opacity ".concat(de,"ms linear")}});X("div",{appendTo:F,className:"riple__",style:{top:D+"px",left:N+"px",opacity:w,width:Re||P*Math.PI+"px",height:Ae||P*Math.PI+"px",background:C,animation:"ripple__ ".concat(ze,"ms ").concat(Pe," both")}});var me=pe?"touchend touchcancel":"mouseleave mouseup";B(this).on(me,function ve(){var Be=this;F.style.opacity=0,setTimeout(function(){return Be.removeChild(F)},de),B(this).off(me,ve)})}}var m=Z(l),K=pe?"touchstart":"mousedown";return m.forEach(function(b){if(je(b))return console.error("Ripple is not allowed on self closing tag you need to wrap it");B(b).on(K,fe)}),{destroy:function(){m.forEach(function(b){return B(b).off(K,fe)})}}}return X("style",{innerHTML:".ripleParent__{pointer-events:none;overflow:hidden;background:transparent;position:absolute;top:50%;left:50%;transform:translate(-50%,-50%)}.riple__{border-radius:50%;position: absolute;will-change:transform; pointer-events:none;}@keyframes ripple__{0%{transform: translate(-50%,-50%) scale(0);}100%{transform: translate(-50%,-50%) scale(1);}}",appendTo:document.head}),ce.utils=ae,ce})})(Se);const sn=Se.exports,Me=x({__proto__:null,default:sn},[Se.exports]),at="ltr",lt="Copied successfully",ct="Telegram",ht="Copy Link",ut="Whatsapp",dt="Twitter",pt="Linkedin",ft="Eitaa",on=Object.freeze(Object.defineProperty({__proto__:null,Direction:at,CopiedSuccessfully:lt,Telegram:ct,Copy_Link:ht,Whatsapp:ut,Twitter:dt,Linkedin:pt,Eitaa:ft,default:{Direction:at,CopiedSuccessfully:lt,Telegram:ct,Copy_Link:ht,Whatsapp:ut,Twitter:dt,Linkedin:pt,Eitaa:ft}},Symbol.toStringTag,{value:"Module"}));return te});
