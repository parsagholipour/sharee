...
\r
`;class Gt extends j{constructor(t,i){super(t,i);o(this,"buttonText","Whatsapp");o(this,"icon",Wt);o(this,"backgroundColor","#25D366");o(this,"backgroundHoverColor","#20bd5a");o(this,"textColor","#fff");o(this,"textHoverColor","#fff")}getLink(){var t,i;return`whatsapp://send?text=${(t=this.options)==null?void 0:t.shareText} 
...
`;class Zt extends j{constructor(t,i){super(t,i);o(this,"buttonText","Copy Link");o(this,"icon",Xt);o(this,"backgroundColor","#797979");o(this,"backgroundHoverColor","#5e5e5e");o(this,"textColor","#fff");o(this,"textHoverColor","#fff");o(this,"timeout",0)}onClick(t){super.onClick(t);const i=this.lang.CopiedSuccessfully,p=t.currentTarget.querySelector("div:nth-child(2)");if(p.innerHTML===i){p.innerHTML=this.getButtonText();return}let M=window.location.href;navigator.clipboard.writeText(M).then(()=>{p.innerHTML=i,p.style.transition="300ms all",p.style.transform="scale(1)",p.style.transform=`scale(1.07) translateX(${this.lang.Direction==="rtl"?"-":""}4px)`,clearTimeout(this.timeout),this.timeout=setTimeout(()=>{p.innerHTML=this.getButtonText(),p.style.transition="none",p.style.transform="scale(1)"},5e3)})}}const qt=`<svg\r
...
`;class en extends j{constructor(t,i){super(t,i);o(this,"buttonText","Facebook");o(this,"icon",Qt);o(this,"backgroundColor","#4267B2");o(this,"backgroundHoverColor","#355696");o(this,"textColor","#fff");o(this,"textHoverColor","#fff")}getLink(){var t,i;return`https://twitter.com/share?text=${encodeURIComponent((t=this.options)==null?void 0:t.shareText)}&url=${(i=this.options)==null?void 0:i.shareLink}`}}const tn=`<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="-2.4 -2.4 28.80 28.80" role="img">\r
...
</svg>`;class nn extends j{constructor(t,i){super(t,i);o(this,"buttonText","Eitaa");o(this,"icon",tn);o(this,"backgroundColor","#e3791c");o(this,"backgroundHoverColor","#d5721a");o(this,"textColor","#fff");o(this,"textHoverColor","#fff")}getLink(){var t,i;return`https://eitaa.com/share/url?url=${(t=this.options)==null?void 0:t.shareLink}&text=${encodeURIComponent((i=this.options)==null?void 0:i.shareText)}`}}const rn=new Object({telegram:Vt,whatsapp:Gt,copy:Zt,twitter:Kt,linkedin:Jt,facebook:en,eitaa:nn});class te{constructor(s,t=_){o(this,"options");o(this,"lang",xe);o(this,"strategy");o(this,"targetElement");this.targetElement=s,this.options=G({},_,t),this.options.drivers=t.drivers||this.options.drivers;const i=Ft[this.options.mode];if(typeof i>"u")throw new Error('Selected mode "'+t.mode+'" not found');this.strategy=new i(this),typeof window<"u"&&this.init().then(()=>{this.strategy.render()})}static addDriver(s,t){this.drivers[s]=t}async init(){this.targetElement.sharee=this,await this.setLang(this.options.lang,this.options.langs)}async setLang(s,t={}){const i=Object.assign({"../locales/en.json":()=>Promise.resolve().then(()=>on),"../locales/fa.json":()=>Promise.resolve().then(()=>zt)});let l=xe;for(const p in i)p.includes(s)&&(i[p]instanceof Function?l={...await i[p]()}:l={...i[p]},t[s]&&G(l,t[s]));this.lang=l}getShareText(){return this.options.shareText||document.title}getShareLink(){return this.options.shareLink||window.location.href}destroy(){this.strategy.destroy()}}o(te,"drivers",{...rn});var Se={exports:{}};/*!
 * ripple-effects
 * customizable ripple effect with one line of code
 *
 * @version v1.0.2
 * @author Cris Fandiño <sircnujnuj@gmail.com>
 */(function(d,s){(function(t,i){d.exports=i()})(W,function(){function t(c,u,h){return u in c?Object.defineProperty(c,u,{value:h,enumerable:!0,configurable:!0,writable:!0}):c[u]=h,c}function i(c,u){var h=Object.keys(c);if(Object.getOwnPropertySymbols){var C=Object.getOwnPropertySymbols(c);u&&(C=C.filter(function(w){return Object.getOwnPropertyDescriptor(c,w).enumerable})),h.push.apply(h,C)}return h}function l(c){for(var u=1;u<arguments.length;u++){var h=arguments[u]!=null?arguments[u]:{};u%2?i(Object(h),!0).forEach(function(C){t(c,C,h[C])}):Object.getOwnPropertyDescriptors?Object.defineProperties(c,Object.getOwnPropertyDescriptors(h)):i(Object(h)).forEach(function(C){Object.defineProperty(c,C,Object.getOwnPropertyDescriptor(h,C))})}return c}function p(c){return/^-+/.test(c)?c:/([^\-]+)([A-Z])/g.test(c)?c.replace(/[A-Z]/g,function(u){return"-"+u.toLowerCase()}):c.toLowerCase()}function M(c,u){var h=c instanceof Element?c:document.createElement(c);if(!u)return h;for(var C in u){var w=u[C];if(/^on([A-Z][a-z A-Z])+/.test(C)){var z=C.toLowerCase().substr(2);h.addEventListener(z,w)}else switch(C){case"style":$(h,w);break;case"appendTo":if(!w)break;w.appendChild(h);break;case"appendChild":h.appendChild(w);break;case"dataset":h.dataset[w[0]]=w[1]||"";break;default:h[C]=w}}return h}function $(c,u){if(typeof u=="string")return getComputedStyle(c).getPropertyValue(p(u));for(var h in u)c.style.setProperty(p(h),u[h])}function ne(c,u){return M(c,u),{on:function(h,C,w){h.split(" ").forEach(function(z){c.addEventListener(z,C,w)})},off:function(h,C){h.split(" ").forEach(function(w){c.removeEventListener(w,C)})}}}function re(c){return["hr","br","img","col","input","embed","area","base","keygen","source","track","wbr"].indexOf(c.tagName.toLowerCase())>-1}function ie(c){var u,h={top:0,left:0};return u=(c&&c.ownerDocument).documentElement,c.getBoundingClientRect!==void 0&&(h=c.getBoundingClientRect()),{top:h.top+window.pageYOffset-u.clientTop,left:h.left+window.pageXOffset-u.clientLeft}}function se(c){for(var u=[],h=0;h<c.length;h++)u.push(c[h]);return u}function oe(c){var u=arguments.length>1&&arguments[1]!==void 0?arguments[1]:document,h=c instanceof HTMLCollection||c instanceof NodeList;return h?se(c):c instanceof Element?[c]:se(u.querySelectorAll(c))}var ae=Object.freeze({__proto__:null,tag:M,styles:$,edit:ne,isSelfTag:re,offset:ie,elementToArray:oe}),He={background:"rgb(150,150,150)",opacity:.5,zIndex:99,duration:700,timing:"ease",outDuration:800},X=M,B=ne,le=ie,Z=oe,je=re,q=$;function ce(){var c=arguments.length>0&&arguments[0]!==void 0?arguments[0]:"_",u=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},h=u=l(l({},He),u),C=h.background,w=h.opacity,z=h.zIndex,ze=h.duration,Pe=h.timing,Ae=h.height,Re=h.width,he=h.triggerOnChild,Ie=he===void 0||he,ue=h.triggerExcept,$e=ue===void 0?"_":ue,de=h.outDuration,pe="ontouchstart"in window;function fe(b){if(!(Z($e,this).indexOf(b.target)>-1)&&(b.target===this||Ie)){var D,N;q(this,"position").toLowerCase()==="static"&&(this.style.position="relative");var H=le(this).top,Y=le(this).left;try{if(b.touches[1])return;N=b.touches[0].pageX-Y,D=b.touches[0].pageY-H}catch{N=b.pageX-Y,D=b.pageY-H}var P=this.offsetWidth,ge=this.offsetHeight,F=X("div",{appendTo:this,className:"ripleParent__",style:{zIndex:z,height:ge+"px",width:P+"px",borderRadius:q(this,"borderRadius"),clipPath:q(this,"clipPath"),transition:"opacity ".concat(de,"ms linear")}});X("div",{appendTo:F,className:"riple__",style:{top:D+"px",left:N+"px",opacity:w,width:Re||P*Math.PI+"px",height:Ae||P*Math.PI+"px",background:C,animation:"ripple__ ".concat(ze,"ms ").concat(Pe," both")}});var me=pe?"touchend touchcancel":"mouseleave mouseup";B(this).on(me,function ve(){var Be=this;F.style.opacity=0,setTimeout(function(){return Be.removeChild(F)},de),B(this).off(me,ve)})}}var m=Z(c),K=pe?"touchstart":"mousedown";return m.forEach(function(b){if(je(b))return console.error("Ripple is not allowed on self closing tag you need to wrap it");B(b).on(K,fe)}),{destroy:function(){m.forEach(function(b){return B(b).off(K,fe)})}}}return X("style",{innerHTML:".ripleParent__{pointer-events:none;overflow:hidden;background:transparent;position:absolute;top:50%;left:50%;transform:translate(-50%,-50%)}.riple__{border-radius:50%;position: absolute;will-change:transform; pointer-events:none;}@keyframes ripple__{0%{transform: translate(-50%,-50%) scale(0);}100%{transform: translate(-50%,-50%) scale(1);}}",appendTo:document.head}),ce.utils=ae,ce})})(Se);const sn=Se.exports,Me=x({__proto__:null,default:sn},[Se.exports]),at="ltr",lt="Copied successfully",ct="Telegram",ht="Copy Link",ut="Whatsapp",dt="Twitter",pt="Linkedin",ft="Eitaa",on=Object.freeze(Object.defineProperty({__proto__:null,Direction:at,CopiedSuccessfully:lt,Telegram:ct,Copy_Link:ht,Whatsapp:ut,Twitter:dt,Linkedin:pt,Eitaa:ft,default:{Direction:at,CopiedSuccessfully:lt,Telegram:ct,Copy_Link:ht,Whatsapp:ut,Twitter:dt,Linkedin:pt,Eitaa:ft}},Symbol.toStringTag,{value:"Module"}));return te});
