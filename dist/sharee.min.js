...
`;class Wt extends R{constructor(t,i){super(t,i);o(this,"buttonText","Copy Link");o(this,"icon",Vt);o(this,"backgroundColor","#797979");o(this,"backgroundHoverColor","#5e5e5e");o(this,"textColor","#fff");o(this,"textHoverColor","#fff");o(this,"timeout",0)}onClick(t){super.onClick(t);const i=this.lang.CopiedSuccessfully,d=t.currentTarget.querySelector("div:nth-child(2)");if(d.innerHTML===i){d.innerHTML=this.getButtonText();return}let M=window.location.href;navigator.clipboard.writeText(M).then(()=>{d.innerHTML=i,d.style.transition="300ms all",d.style.transform="scale(1)",d.style.transform=`scale(1.07) translateX(${this.lang.Direction==="rtl"?"-":""}4px)`,clearTimeout(this.timeout),this.timeout=setTimeout(()=>{d.innerHTML=this.getButtonText(),d.style.transition="none",d.style.transform="scale(1)"},5e3)})}}const Gt=`<svg\r
