...
`;class Gt extends I{constructor(t,i){super(t,i);o(this,"buttonText","Copy Link");o(this,"icon",Wt);o(this,"backgroundColor","#797979");o(this,"backgroundHoverColor","#5e5e5e");o(this,"textColor","#fff");o(this,"textHoverColor","#fff");o(this,"timeout",0)}onClick(t){super.onClick(t);const i=this.lang.CopiedSuccessfully,g=t.currentTarget.querySelector("div:nth-child(2)");if(g.innerHTML===i){g.innerHTML=this.getButtonText();return}let M=window.location.href;navigator.clipboard.writeText(M).then(()=>{g.innerHTML=i,g.style.transition="300ms all",g.style.transform="scale(1)",g.style.transform=`scale(1.07) translateX(${this.lang.Direction==="rtl"?"-":""}4px)`,clearTimeout(this.timeout),this.timeout=setTimeout(()=>{g.innerHTML=this.getButtonText(),g.style.transition="none",g.style.transform="scale(1)"},5e3)})}}const Xt=`<svg\r
...
`;class Jt extends I{constructor(t,i){super(t,i);o(this,"buttonText","Facebook");o(this,"icon",Yt);o(this,"backgroundColor","#4267B2");o(this,"backgroundHoverColor","#355696");o(this,"textColor","#fff");o(this,"textHoverColor","#fff")}getLink(){var t,i;return`https://twitter.com/share?text=${encodeURIComponent((t=this.options)==null?void 0:t.shareText)}&url=${(i=this.options)==null?void 0:i.shareLink}`}}const Qt=new Object({telegram:Ft,whatsapp:Vt,copy:Gt,twitter:Zt,linkedin:Kt,facebook:Jt});class te{constructor(s,t=_){o(this,"options");o(this,"lang",xe);o(this,"strategy");o(this,"targetElement");this.targetElement=s,this.options=G({},_,t),this.options.drivers=t.drivers||this.options.drivers;const i=Bt[this.options.mode];if(typeof i>"u")throw new Error('Selected mode "'+t.mode+'" not found');this.strategy=new i(this),typeof window<"u"&&this.init().then(()=>{this.strategy.render()})}static addDriver(s,t){this.drivers[s]=t}async init(){this.targetElement.sharee=this,await this.setLang(this.options.lang,this.options.langs)}async setLang(s,t={}){const i=Object.assign({"../locales/en.json":()=>Promise.resolve().then(()=>tn),"../locales/fa.json":()=>Promise.resolve().then(()=>Ht)});let c=xe;for(const g in i)g.includes(s)&&(i[g]instanceof Function?c={...await i[g]()}:c={...i[g]},t[s]&&G(c,t[s]));this.lang=c}getShareText(){return this.options.shareText||document.title}getShareLink(){return this.options.shareLink||window.location.href}destroy(){this.strategy.destroy()}}o(te,"drivers",{...Qt});var Se={exports:{}};/*!
 * ripple-effects
 * customizable ripple effect with one line of code
 *
 * @version v1.0.2
 * @author Cris Fandiño <sircnujnuj@gmail.com>
 */(function(f,s){(function(t,i){f.exports=i()})(W,function(){function t(l,u,h){return u in l?Object.defineProperty(l,u,{value:h,enumerable:!0,configurable:!0,writable:!0}):l[u]=h,l}function i(l,u){var h=Object.keys(l);if(Object.getOwnPropertySymbols){var C=Object.getOwnPropertySymbols(l);u&&(C=C.filter(function(w){return Object.getOwnPropertyDescriptor(l,w).enumerable})),h.push.apply(h,C)}return h}function c(l){for(var u=1;u<arguments.length;u++){var h=arguments[u]!=null?arguments[u]:{};u%2?i(Object(h),!0).forEach(function(C){t(l,C,h[C])}):Object.getOwnPropertyDescriptors?Object.defineProperties(l,Object.getOwnPropertyDescriptors(h)):i(Object(h)).forEach(function(C){Object.defineProperty(l,C,Object.getOwnPropertyDescriptor(h,C))})}return l}function g(l){return/^-+/.test(l)?l:/([^\-]+)([A-Z])/g.test(l)?l.replace(/[A-Z]/g,function(u){return"-"+u.toLowerCase()}):l.toLowerCase()}function M(l,u){var h=l instanceof Element?l:document.createElement(l);if(!u)return h;for(var C in u){var w=u[C];if(/^on([A-Z][a-z A-Z])+/.test(C)){var j=C.toLowerCase().substr(2);h.addEventListener(j,w)}else switch(C){case"style":$(h,w);break;case"appendTo":if(!w)break;w.appendChild(h);break;case"appendChild":h.appendChild(w);break;case"dataset":h.dataset[w[0]]=w[1]||"";break;default:h[C]=w}}return h}function $(l,u){if(typeof u=="string")return getComputedStyle(l).getPropertyValue(g(u));for(var h in u)l.style.setProperty(g(h),u[h])}function ne(l,u){return M(l,u),{on:function(h,C,w){h.split(" ").forEach(function(j){l.addEventListener(j,C,w)})},off:function(h,C){h.split(" ").forEach(function(w){l.removeEventListener(w,C)})}}}function re(l){return["hr","br","img","col","input","embed","area","base","keygen","source","track","wbr"].indexOf(l.tagName.toLowerCase())>-1}function ie(l){var u,h={top:0,left:0};return u=(l&&l.ownerDocument).documentElement,l.getBoundingClientRect!==void 0&&(h=l.getBoundingClientRect()),{top:h.top+window.pageYOffset-u.clientTop,left:h.left+window.pageXOffset-u.clientLeft}}function se(l){for(var u=[],h=0;h<l.length;h++)u.push(l[h]);return u}function oe(l){var u=arguments.length>1&&arguments[1]!==void 0?arguments[1]:document,h=l instanceof HTMLCollection||l instanceof NodeList;return h?se(l):l instanceof Element?[l]:se(u.querySelectorAll(l))}var ae=Object.freeze({__proto__:null,tag:M,styles:$,edit:ne,isSelfTag:re,offset:ie,elementToArray:oe}),He={background:"rgb(150,150,150)",opacity:.5,zIndex:99,duration:700,timing:"ease",outDuration:800},X=M,B=ne,le=ie,Z=oe,je=re,q=$;function he(){var l=arguments.length>0&&arguments[0]!==void 0?arguments[0]:"_",u=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},h=u=c(c({},He),u),C=h.background,w=h.opacity,j=h.zIndex,Pe=h.duration,ze=h.timing,Ae=h.height,Re=h.width,ce=h.triggerOnChild,Ie=ce===void 0||ce,ue=h.triggerExcept,$e=ue===void 0?"_":ue,de=h.outDuration,fe="ontouchstart"in window;function pe(b){if(!(Z($e,this).indexOf(b.target)>-1)&&(b.target===this||Ie)){var D,N;q(this,"position").toLowerCase()==="static"&&(this.style.position="relative");var H=le(this).top,Y=le(this).left;try{if(b.touches[1])return;N=b.touches[0].pageX-Y,D=b.touches[0].pageY-H}catch{N=b.pageX-Y,D=b.pageY-H}var P=this.offsetWidth,ge=this.offsetHeight,F=X("div",{appendTo:this,className:"ripleParent__",style:{zIndex:j,height:ge+"px",width:P+"px",borderRadius:q(this,"borderRadius"),clipPath:q(this,"clipPath"),transition:"opacity ".concat(de,"ms linear")}});X("div",{appendTo:F,className:"riple__",style:{top:D+"px",left:N+"px",opacity:w,width:Re||P*Math.PI+"px",height:Ae||P*Math.PI+"px",background:C,animation:"ripple__ ".concat(Pe,"ms ").concat(ze," both")}});var me=fe?"touchend touchcancel":"mouseleave mouseup";B(this).on(me,function ve(){var Be=this;F.style.opacity=0,setTimeout(function(){return Be.removeChild(F)},de),B(this).off(me,ve)})}}var m=Z(l),K=fe?"touchstart":"mousedown";return m.forEach(function(b){if(je(b))return console.error("Ripple is not allowed on self closing tag you need to wrap it");B(b).on(K,pe)}),{destroy:function(){m.forEach(function(b){return B(b).off(K,pe)})}}}return X("style",{innerHTML:".ripleParent__{pointer-events:none;overflow:hidden;background:transparent;position:absolute;top:50%;left:50%;transform:translate(-50%,-50%)}.riple__{border-radius:50%;position: absolute;will-change:transform; pointer-events:none;}@keyframes ripple__{0%{transform: translate(-50%,-50%) scale(0);}100%{transform: translate(-50%,-50%) scale(1);}}",appendTo:document.head}),he.utils=ae,he})})(Se);const en=Se.exports,Me=x({__proto__:null,default:en},[Se.exports]),ot="ltr",at="Copied successfully",lt="Telegram",ht="Copy Link",ct="Whatsapp",ut="Twitter",dt="Linkedin",tn=Object.freeze(Object.defineProperty({__proto__:null,Direction:ot,CopiedSuccessfully:at,Telegram:lt,Copy_Link:ht,Whatsapp:ct,Twitter:ut,Linkedin:dt,default:{Direction:ot,CopiedSuccessfully:at,Telegram:lt,Copy_Link:ht,Whatsapp:ct,Twitter:ut,Linkedin:dt}},Symbol.toStringTag,{value:"Module"}));return te});
