...
const p = {
  ...
  ripple: !0,
  mode: "normal"
}, g = "rtl", C = "اشتراک در تلگرام", f = "کپی لینک", v = "با موفقیت کپی شد!", L = "اشتراک در واتساپ", w = "اکس", x = "اشتراک در لینکدین", k = "اشتراک در فیسبوک", y = "اشتراک در ایتا", h = {
  Direction: g,
  Telegram: C,
  Copy_Link: f,
...
class u extends d {
  ...
  renderDriver(e) {
    e.mainEl = document.createElement("a"), "hasLink" in e && e.hasLink() && (e.mainEl.href = e.getLink()), this.initDriverStyles(e), this.listenDriverEvents(e);
...
class H extends u {
  ...
  renderDriver(s) {
    s.mainEl = document.createElement("a"), s.mainEl.title = s.getButtonText(), s.hasLink() && (s.mainEl.href = s.getLink()), this.initDriverStyles(s), this.listenDriverEvents(s);
...
class R extends d {
  ...
  renderDriver(e) {
    e.mainEl = document.createElement("a"), e.hasLink() && (e.mainEl.href = e.getLink()), this.initDriverStyles(e), this.listenDriverEvents(e);
    const t = document.createElement("div");
    t.innerHTML = e.icon;
    const i = document.createElement("div");
...
class O extends d {
  ...
  onDriverClick(e) {
    return (t) => {
      t.defaultPrevented || e.onClick(t);
    };
  }
  initDriverStyles(e) {
    var t, i;
...
class a {
  ...
  onClick(s) {
    var t;
    const e = new CustomEvent("driver-clicked", {
      detail: {
        name: this.getName(),
        link: this.getLink(),
        originalEvent: s
    ...
    (t = this.options) == null || t.targetElement.dispatchEvent(e);
  }
  getName() {
...
let U = class extends a {
  ...
  getLink() {
    var e, t;
    return `https://telegram.me/share/url?url=${encodeURIComponent(((e = this.options) == null ? void 0 : e.shareLink) ?? "")}&text=${encodeURIComponent((t = this.options) == null ? void 0 : t.shareText)}`;
  }
};
...
class P extends a {
  ...
  getLink() {
    var t, i;
    const e = [((t = this.options) == null ? void 0 : t.shareText) ?? "", ((i = this.options) == null ? void 0 : i.shareLink) ?? ""].filter(Boolean).join(`
`);
...
class N extends a {
  ...
  onClick(e) {
    if (super.onClick(e), e.defaultPrevented)
      return;
...
class F extends a {
  ...
  getLink() {
    var e;
    return `https://www.linkedin.com/shareArticle?url=${encodeURIComponent(((e = this.options) == null ? void 0 : e.shareLink) ?? "")}`;
  }
}
...
class q extends a {
  ...
  getLink() {
    var e, t;
    return `https://facebook.com/sharer/sharer.php?u=${encodeURIComponent(((e = this.options) == null ? void 0 : e.shareLink) ?? "")}&t=${encodeURIComponent((t = this.options) == null ? void 0 : t.shareText)}`;
  }
}
...
class Z extends a {
  ...
  getLink() {
    var e, t;
    return `https://eitaa.com/share/url?url=${encodeURIComponent(((e = this.options) == null ? void 0 : e.shareLink) ?? "")}&text=${encodeURIComponent((t = this.options) == null ? void 0 : t.shareText)}`;
  }
}
const J = new Object({
  telegram: U,
...
class c {
  ...
  async init() {
    this.targetElement.sharee = this, await this.setLang(this.options.lang, this.options.langs), this.initEventListeners();
  }
  initEventListeners() {
    var s;
    (s = this.options) != null && s.onDriverClick && this.targetElement.addEventListener("driver-clicked", this.options.onDriverClick);
  }
  destroyEventListeners() {
    var s;
    (s = this.options) != null && s.onDriverClick && this.targetElement.removeEventListener("driver-clicked", this.options.onDriverClick);
  }
  async setLang(s, e = {}) {
  ...
  destroy() {
    this.strategy.destroy(), this.destroyEventListeners();
  }
}
n(c, "drivers", { ...J });
export {
